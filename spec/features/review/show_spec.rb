...
RSpec.describe "review_show", type: :feature do
  before :each do
    ...
    @review_25 = @book_2.reviews.create(title: "Dang", rating: 2, review_text: "I left my lunch at home. WHOOPS, wrong forum for this.", username: "Chickenhawk")
    @review_26 = @book_3.reviews.create(title: "Not bad", rating: 3, review_text: "Also not good. But that might be because I was trying to read it while driving and crashed my car.", username: "Userone")
    @review_27 = @book_4.reviews.create(title: "Not my strong suit", rating: 2, review_text: "I'm more the street smart type so this was an experiment that went wrong, but I'm glad for the experience.", username: "Omae")
    @review_28 = @book_5.reviews.create(title: "$W337", rating: 5, review_text: "L337 B00K", username: "Chickenhawk")
    @review_29 = @book_6.reviews.create(title: "This book.", rating: 5, review_text: " This book changed my life, but only because time passed while I read it so even this review is changing my life. Oof, I need to sit down.", username: "Cowsmeow")
    @review_30 = @book_7.reviews.create(title: "OK", rating: 3, review_text: "I SAID IT WAS OKAY WHAT MORE DO YOU WANT FROM ME? Sorry, I didn't realize caps lock was on and I don't feel like retyping all of that.", username: "Friednoodles")
  end
